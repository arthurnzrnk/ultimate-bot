...
export default function Dashboard() {
  ...
  function drawChart(
    ...
    overlays?.forEach(o => {
      ...
      ctx.strokeStyle = o.color || '#1e293b'
      ctx.lineWidth = 1.6
  ...
  useEffect(() => {
    ...
    overlays.push({ data: vwap, color: '#1e40af', dashed: true })
    const pos = data?.pos
        ...
        <div className="right-col">
          <section className="glass pcard">
            <div className="switch-row">
              <div className="brand-mini">COINSELF</div>
              <div
                role="switch"
                aria-checked={data.autoTrade}
                className={`switch ${data.autoTrade ? 'on' : 'off'}`}
                onClick={toggleAuto}
                title="Toggle auto trading"
              >
            ...
            <div className="switch-hint">The system will trade automatically until you turn the bot OFF.</div>
          </section>
